...
import 'package:homely_seller/Helper/SimBtn.dart';
import 'package:homely_seller/Helper/String.dart';
import 'package:homely_seller/Model/Attribute%20Models/AttributeModel/AttributesModel.dart';
import 'package:homely_seller/Model/Attribute%20Models/AttributeSetModel/AttributeSetModel.dart';
import 'package:homely_seller/Model/Attribute%20Models/AttributeValueModel/AttributeValue.dart';
import 'package:homely_seller/Model/CategoryModel/categoryModel.dart';
import 'package:homely_seller/Model/ProductModel/Variants.dart';
import 'package:homely_seller/Model/TaxesModel/TaxesModel.dart';
import 'package:homely_seller/Model/ZipCodesModel/ZipCodeModel.dart';
import 'package:homely_seller/Screen/Home.dart';
import 'package:homely_seller/Helper/inputChipUxScreen.dart';
        ...
        children: [
          Padding(
            ...
            child: Container(
              width: width * 0.4,
              child: Text(
                getTranslated(context, "PackingCharge")! + " :",
                style: TextStyle(
                  fontSize: 16,
                  color: black,
                ),
  ...
  Future<void> addProductAPI(List<String> attributesValuesIds) async {
    ...
    if (_isNetworkAvail) {
      try {
        ...
        request.fields[PackageCharge] = minOrderQuantity.toString();
        ...
        print("reuest fields : ${request.fields} and ${addProductsApi} and ${request.files}");
